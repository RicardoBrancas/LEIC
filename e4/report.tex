...
\lstset{language=SQL}
\lstset{basicstyle=\footnotesize\ttfamily,morekeywords={BEFORE,EACH,ROW,PROCEDURE,NEW,IF,REFERENCES,TYPE,ENUM,REPLACE,FUNCTION,RETURNS,VOID,DECLARE,BEGIN,DEFERRED,FOR,LOOP,LANGUAGE,RAISE,SETOF,WHILE,RETURN,QUERY,HASH,TEMP,BTREE}}
