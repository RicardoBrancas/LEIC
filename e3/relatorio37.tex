...
\lstset{language=SQL}
\lstset{basicstyle=\footnotesize\ttfamily,breaklines=true,morekeywords={IF,REFERENCES,TYPE,ENUM,REPLACE,FUNCTION,RETURNS,VOID,DECLARE,BEGIN,DEFERRED,FOR,LOOP,LANGUAGE,RAISE,SETOF,WHILE,RETURN,QUERY}}
